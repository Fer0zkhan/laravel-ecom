                                ...
                                <table class="table card-table table-responsive" id="table_id" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>24541</td>
                                            <td>
                                                <a class="text-dark">Alpha Shirt</a>
                                            </td>
                                            <td class="d-none d-md-table-cell">2930$</td>
                                            <td class="d-none d-md-table-cell">Shirts</td>
                                            <td class="d-none d-md-table-cell">shirt.jpg</td>
                                            <td>
                                                <span class="badge badge-warning">Active</span>
                                            </td>
                                            <td class="text-right">
